...
export function About() {
  return (
    <section id="about" className="py-20 bg-brand-200">
      <div className="max-w-6xl mx-auto px-6 md:flex md:items-center md:flex-row-reverse md:gap-16">
        <div>
          <header className="mb-6">
            ...
            <h2 className="font-bold text-3xl md:text-4xl text-brand-headline">Entenda quem somos e por que existimos</h2>
          </header>
          ...
          <img 
            className="max-w-full md:max-w-md object-cover"
            src={doctorImageUrl}
