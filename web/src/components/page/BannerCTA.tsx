...
export function BannerCTA() {
  ...
  return (
    <section className="md:px-6 relative 
      before:w-full before:h-1/2 before:absolute before:top-0 before:left-0 before:-z-10 before:bg-surface-primary
      after:w-full after:h-1/2 after:absolute after:bottom-0 after:left-0 after:-z-10 after:bg-surface-secondary
    ">
