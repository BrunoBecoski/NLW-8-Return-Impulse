...
export function Header() {
  ...
  return (
    <header id="header" className="text-center px-6 pt-10 before:w-full before:h-[1040px] before:absolute before:top-0 before:left-0 before:z-[-1] before:bg-brand-200">
