  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <span className="text-xl text-headline mt-2">Agradecemos o feedback!</span>

        <button
          type="button"
          onClick={onFeedbackRestartRequested}
          className="py-2 px-6 mt-6 bg-brand-500 rounded-md border-transparent text-sm leading-6 hover:bg-brand-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-headline focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
